...
urlpatterns = [
    ...
    path('api/ReadSensorSettings', views.ReadDeviceIoTProperties().as_view()),
    ...
    path('api/updateDataCenterDeviceIOTags', views.UpdateDataCenterDeviceIOTags.as_view()),
    ...
    path('api/getspecificdata', views.GetSpecificTimeData().as_view()),
    path('api/livedata', views.GetLiveData().as_view()),
    path('', AppViews.index_test, name='index'),
